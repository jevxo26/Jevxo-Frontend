        ...
        <div className="bg-card-gradient border border-card-border rounded-3xl p-8 lg:p-12 shadow-2xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            ...
            <div className="lg:col-span-5 flex flex-col">
              ...
              <div className="mb-8">
                <div className="flex justify-between text-sm font-bold mb-4">
                  <span className="text-foreground">Monthly Enrollment</span>
                  <span className="text-accent">
                ...
                <input
                  ...
                  className="w-full h-2 bg-muted rounded-lg appearance-none cursor-pointer accent-accent hover:accent-cyan-600 transition-all"
                />

                <div className="flex justify-between text-[10px] font-bold text-muted mt-2 uppercase">
                  <span>100</span>
                  <span>10k+</span>
                </div>
              </div>
              ...
              {/* Toggle Area */}
              <div className="flex p-1 bg-card rounded-xl border border-card-border">
                <button
                  onClick={() => setIsYearly(false)}
                  className={`flex-1 py-2.5 text-xs font-bold rounded-lg transition-all ${!isYearly ? "bg-accent text-background shadow-md" : "text-muted"}`}
                >
                  MONTHLY
                </button>
                <button
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {/* Cost Card */}
              <div className="bg-card border border-card-border rounded-2xl p-6 flex flex-col justify-between min-h-[200px]">
                <div>
                  <Wallet className="text-accent mb-4" size={24} />
                  <p className="text-muted text-[10px] font-bold uppercase tracking-widest mb-1">
                    Estimated Monthly Cost
                  </p>
                </div>
                <div>
                  <h4 className="text-accent text-4xl font-bold mb-2">
              ...
              {/* Savings Card */}
              <div className="bg-card border border-card-border rounded-2xl p-6 flex flex-col justify-between min-h-[200px] relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <PiggyBank className="text-secondary mb-4" size={24} />
                  <p className="text-muted text-[10px] font-bold uppercase tracking-widest mb-1">
                    Estimated Annual Savings
                  </p>
                </div>
                <div className="relative z-10">
                  <h4 className="text-secondary text-4xl font-bold mb-2">
